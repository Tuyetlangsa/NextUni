...
namespace NextUni.Modules.Chatbot.Infrastructure.Outbox;
    ...
    where TDomainEvent : IDomainEvent
{
        ...
        OutboxMessageConsumer outboxMessageConsumer)
    {
        const string sql = 
            ...
            SELECT EXISTS(
                SELECT 1
                FROM chatbot.outbox_message_consumers
        ...
        OutboxMessageConsumer outboxMessageConsumer)
    {
        const string sql =
            """
            INSERT INTO chatbot.outbox_message_consumers(outbox_message_id, name)
