...
namespace NextUni.Modules.Contents.Application.ApproveUniversityCounsellingArticle
{
    public abstract class ApproveUniversityCounsellingArticle
    {
        ...
        IDateTimeProvider dateTimeProvider) : ICommandHandler<Command, Guid>
        {
            public async Task<Result<Guid>> Handle(Command command, CancellationToken cancellationToken)
            {
                ...
                article.Status = CounsellingArticleStatus.Published;
