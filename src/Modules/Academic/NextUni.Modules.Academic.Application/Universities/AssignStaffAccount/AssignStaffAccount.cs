...
namespace NextUni.Modules.Academic.Application.Universities.AssignStaffAccount;


public abstract class AssignStaffAccount
{
        ...
        IAcademicDbContext dbContext) : ICommandHandler<Command>
    {
        public async Task<Result> Handle(Command command, CancellationToken cancellationToken)
        {
            ...
            university.StaffAccountId = command.StaffId;
